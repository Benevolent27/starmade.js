...
var {objectHelper,miscHelpers}=global;
...
var commands={};
var commandOperator;
var settings=global.settings.servers[serverPath];
CommandObj.prototype.toString = function(){ return this.name };
global.event.on('start',function(forServerPath){ // The serverObj has been created.
    if (forServerPath == serverPath){ // Only proceed for THIS server, not other servers
        serverObj=global.getServerObj(__dirname);
